...
|--------------------|-------------|---------------------------------------------------|----------|----------|--------------------------------------|
| industry           | string      | ai_blueprint, ai_brand_identity, business_plan, site_audit | true     |          | SaaS                                 |
| audience           | string      | ai_blueprint, ai_brand_identity, business_plan, email_campaign, site_audit, social_content | true     |          | Small business owners                |
| goal               | string      | ai_blueprint, business_plan, promptLogs, reverse_strategy, email_campaign | true     |          | Launch MVP                           |
| constraints        | string      | ai_blueprint, reverse_strategy                    | false    |          | None                                 |
| tone               | string      | ai_blueprint, ai_brand_identity, business_plan, email_campaign, reverse_strategy, site_audit, social_content | false    | ✅       | Empowering                           |
...
| keyMessage         | string      | email_campaign, social_content                    | false    |          | Unlock your business potential       |
