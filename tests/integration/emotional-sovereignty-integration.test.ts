...
describe('Emotional Sovereignty Integration Tests', () => {
  ...
  describe('Event Bus Integration', () => {
    test('should emit proper events throughout the flow', async () => {
      ...
      eventBus.on('emotional-sovereignty-started', (data) => events.push({ type: 'started', data }));
      eventBus.on('emotional-sovereignty-completed', (data) => events.push({ type: 'completed', data }));
      eventBus.on('EMOTIONAL_SOVEREIGNTY_SUCCESS', (data) => events.push({ type: 'success', data }));
