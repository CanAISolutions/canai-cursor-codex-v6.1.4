...
Write-Host "Starting Day 3 Remediation..."
Write-Host "URL: $env:SUPABASE_URL"

# Run Day 3 remediation script
node "workspace-organization/02-orchestration/make-com/supabase-dev/verification/scripts/day3-remediation.js" 