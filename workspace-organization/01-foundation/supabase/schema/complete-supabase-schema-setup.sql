...
-- PromptLogs: Universal prompt tracking with JSONB flexibility (PARTITIONED for performance)
...
-- ============================================================================
-- PARTITIONING STRATEGY (Production-Ready Performance)
-- ============================================================================

-- Create initial partitions for prompt_logs (3 months ahead)
...
CREATE TABLE prompt_logs_2025_03 PARTITION OF prompt_logs
    FOR VALUES FROM ('2025-03-01') TO ('2025-04-01');

CREATE TABLE prompt_logs_2025_04 PARTITION OF prompt_logs
    FOR VALUES FROM ('2025-04-01') TO ('2025-05-01');

-- Default partition for future data (safety net)
