 ...
 * 
 * Usage:
 * node scripts/prompt-generator.js --file=path/to/file.js --start=10 --end=25 --domain=react --goal="Fix validation bug"
 */
...
function main() {
  try {
    ...
    if (!options.filePath) {
      console.error('Usage: node scripts/prompt-generator.js --file=path/to/file --start=10 --end=25 --goal="Fix bug"');
